<?php $__env->startSection('css'); ?>
    <script type="text/javascript" src="<?php echo e(config('voyager.assets_path')); ?>/js/vue21.min.js"></script>
    <link rel="stylesheet" href="<?php echo e(config('voyager.assets_path')); ?>/css/database.css">
            ...
            <?php $__currentLoopData = $tables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $table): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php if($table->dataTypeId): ?>
                                <a href="<?php echo e(route('voyager.database.edit_bread', $table->name)); ?>"
                            ...
                            <?php else: ?>
                                <a href="<?php echo e(route('voyager.database.create_bread', ['name' => $table->name])); ?>"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="<?php echo e(route('voyager.database.delete_bread', ['id' => null])); ?>" id="delete_builder_form" method="POST">
