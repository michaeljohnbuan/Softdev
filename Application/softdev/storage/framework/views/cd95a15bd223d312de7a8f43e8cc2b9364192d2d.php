	...
	<div id="blue">
	  ...
	  <div class="container mtb">
	 	<div class="row">
	 		...
	 		<div class="col-lg-6">
	 		<br>
		 		<h4>Cooking with Claypots</h4>
		 		<br>
		 		<p>Use a clay azalea pot (so named because azaleas are grown in them). They are about 14" across, but are shorter than regular pots. You can also use small flower pots (clay) for individual stoves (about 6-8" across the top </p>
		 		
		 		<p>Put some screen mesh in the bottom over the hole. Fill pot part way with pea gravel or sand about 1/2 to 2/3 full. This adds weight and brings the coal area up nearer your food. </p>
		 		<p>
