...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(config('voyager.assets_path')); ?>/lib/css/perfect-scrollbar.min.css">
...
<script type="text/javascript" src="<?php echo e(config('voyager.assets_path')); ?>/lib/js/perfect-scrollbar.jquery.min.js"></script>
<script type="text/javascript" src="<?php echo e(config('voyager.assets_path')); ?>/js/select2/select2.min.js"></script>
...
<script type="text/javascript" src="<?php echo e(config('voyager.assets_path')); ?>/js/helpers.js"></script>
<script>
