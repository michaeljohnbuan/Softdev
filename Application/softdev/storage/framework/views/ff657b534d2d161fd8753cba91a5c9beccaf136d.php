<?php $__env->startSection('css'); ?>
    <script type="text/javascript" src="<?php echo e(config('voyager.assets_path')); ?>/js/vue1.min.js"></script>
    <link rel="stylesheet" href="<?php echo e(config('voyager.assets_path')); ?>/css/media/media.css"/>
    <link rel="stylesheet" type="text/css" href="<?php echo e(config('voyager.assets_path')); ?>/js/select2/select2.min.css">
    <link rel="stylesheet" href="<?php echo e(config('voyager.assets_path')); ?>/css/media/dropzone.css"/>
...
<script src="<?php echo e(config('voyager.assets_path')); ?>/js/media/dropzone.js"></script>
<script src="<?php echo e(config('voyager.assets_path')); ?>/js/media/media.js"></script>
<script type="text/javascript">
    var media = new VoyagerMedia({
        baseUrl: "<?php echo e(route('voyager.dashboard')); ?>"
    });
    $(function () {
        media.init();
    });
