<?php $__env->startSection('css'); ?>
    <link rel="stylesheet" type="text/css" href="<?php echo e(config('voyager.assets_path')); ?>/css/ga-embed.css">
...
<?php $__env->startSection('javascript'); ?>
    ...
    <?php if(isset($google_analytics_client_id) && !empty($google_analytics_client_id)): ?>
        ...
        <script src="<?php echo e(config('voyager.assets_path')); ?>/js/ga-embed/chart.min.js"></script>
        <script src="<?php echo e(config('voyager.assets_path')); ?>/js/ga-embed/moment.min.js"></script>
        <!-- Include the ViewSelector2 component script. -->
        <script src="<?php echo e(config('voyager.assets_path')); ?>/js/ga-embed/view-selector2.js"></script>
        <!-- Include the DateRangeSelector component script. -->
        <script src="<?php echo e(config('voyager.assets_path')); ?>/js/ga-embed/date-range-selector.js"></script>
        <!-- Include the ActiveUsers component script. -->
        <script src="<?php echo e(config('voyager.assets_path')); ?>/js/ga-embed/active-users.js"></script>
