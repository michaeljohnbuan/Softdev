                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="slug" name="slug"
                                    placeholder="slug"
                                    <?php if(isset($dataTypeContent)): ?><?php echo isFieldSlugAutoGenerator($dataTypeContent, "slug"); ?><?php endif; ?>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="category_id">
                                    <?php $__currentLoopData = TCG\Voyager\Models\Category::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
