...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(config('voyager.assets_path')); ?>/lib/css/bootstrap.min.css">
    <link rel="stylesheet" href="<?php echo e(config('voyager.assets_path')); ?>/css/animate.min.css">
    <link rel="stylesheet" href="<?php echo e(config('voyager.assets_path')); ?>/css/login.css">
    <style>
        body {
            ...
            <div class="clearfix">
                <div class="col-sm-12 col-md-10 col-md-offset-2">
                    <div class="logo-title-container">
                        ...
                        <img class="img-responsive pull-left logo hidden-xs animated fadeIn" src="<?php echo e(config('voyager.assets_path')); ?>/images/logo-icon-light.png" alt="Logo Icon">
                        <?php else: ?>
