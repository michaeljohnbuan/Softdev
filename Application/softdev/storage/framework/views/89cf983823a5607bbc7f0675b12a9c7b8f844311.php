...
<div class="panel panel-bordered">
    <div class="panel-heading">
        <h3 class="panel-title"><?php if($db->action == 'update'): ?><?php echo e("Edit the {$db->table->name} table below"); ?><?php else: ?><?php echo e('Create Your New Table Below'); ?><?php endif; ?></h3>
    </div>
    ...
    <div class="panel-body">
        ...
        <?php endif; ?>
                ...
                <input v-model.trim="table.name" type="text" class="form-control" placeholder="Table Name" required pattern="<?php echo e($db->identifierRegex); ?>">
            </div>
    ...
    <div class="panel-footer">
        <input type="submit" class="btn btn-primary pull-right"
               value="<?php if($db->action == 'update'): ?><?php echo e('Update Table'); ?><?php else: ?><?php echo e('Create New Table'); ?><?php endif; ?>"
...
<?php echo $__env->make('voyager::tools.database.vue-components.database-column', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
