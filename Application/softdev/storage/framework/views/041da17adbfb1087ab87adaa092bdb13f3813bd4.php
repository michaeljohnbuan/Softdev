          ...
          <ul class="nav navbar-nav">
			...
			<li class="dropdown active">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="/single_project">SINGLE PROJECT</a></li>
              </ul>
            </li>
	 ...
	 ***************************************************************************************************************** -->
	 <div id="portfoliowrap">
        <div class="portfolio-centered">
        	<h3>List of Emergency Procedures.</h3>

            	 <?php while($row = mysqli_fetch_array($search_result)):?>
               
                    <h2><a href="../emergency_procedures/setup_fire.html" target="_blank"><?php echo $row['first_procedures'];?><br></a>
